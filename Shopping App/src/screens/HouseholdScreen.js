...
export default class HouseholdScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      modalVisible:false,
      userSelected:[],
      data: require('../../Json/household.json'),
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.headerStyle}>Household Items</Text>
        <FlatList
          style={styles.userList}
          columnWrapperStyle={styles.listContainer}
          data={data['Household Appliance'] }
          keyExtractor= {(item) => {
            return item.id;
          }}
          renderItem={({item}) => {
            ...
            <View style={styles.popup}>
              <View style={styles.popupContent}>
                <ScrollView contentContainerStyle={styles.modalInfo}>
                    ...
                    <Text style={styles.price}>Price: {this.state.userSelected.price}Naira</Text>
                </ScrollView>
              </View>
